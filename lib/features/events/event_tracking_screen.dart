      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final confirmedBookings = bookings
              ...
              .toList();
          final totalSlotsBooked = confirmedBookings.fold<int>(
            0,
            (sum, booking) => sum + booking.slotsBooked,
          );
          final totalRevenue = confirmedBookings.fold<int>(
            0,
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${((totalSlotsBooked / event.totalSlots) * 100).toStringAsFixed(1)}%',
                              style: const TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Colors.orange,
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            value: totalSlotsBooked / event.totalSlots,
